	...
	<div id="wrapper">
		<div id="container" class="container">  
			<div class=" row">
                ...
                <div class="col-md-2 feedtwitter">
					<a href="<?php bloginfo('rss2_url'); ?>"><img alt="" src="<?php bloginfo('template_url'); ?>/images/rss.png"  style="margin:0 4px 0 0;"  /></a>		
					<?php if(get_theme_option('twitter') != '') { ?><a href="<?php echo get_theme_option('twitter'); ?>" title="<?php echo get_theme_option('twittertext'); ?>"><img alt="" src="<?php bloginfo('template_url'); ?>/images/twitter.png"  style="margin:0 4px 0 0; "  title="<?php echo get_theme_option('twittertext'); ?>" /></a><?php } ?>
				</div>
                
				<div id="topsearch" class="col-md-3 last">
					<?php get_search_form(); ?> 
				</div>
			</div>
